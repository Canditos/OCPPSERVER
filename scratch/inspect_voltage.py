...
conn = sqlite3.connect('ocpp.db')
c = conn.cursor()

print('=== LAST 5 METER VALUES IN DB ===')
for r in c.execute('SELECT transaction_id, connector_id, timestamp, measurand, phase, unit, value FROM meter_values ORDER BY id DESC LIMIT 15'):
    print(r)
